...
# --- User config ---
BET365_USER = "milliumfolie"
BET365_PASS = "Thep0wer0fn0w!"
STORAGE_FILE = Path("bet365_state.json")
# -------------------
...
def get_bet365_odds(url: str) -> Dict:
    """
    Fetch full-time odds from a Bet365 competition page.
    Uses BET365_USER / BET365_PASS once to create session,
    then reuses STORAGE_FILE afterwards.
    """
    async_coro = _scrape_odds_async(
        url=url,
        username=BET365_USER,
        password=BET365_PASS,
